...
"""Default-path identity of implicit_mhd.fluid_reconstruction.
...
written at all:
  ...
  * the base deck with NO implicit_mhd.fluid_reconstruction line, and
  * the same deck with implicit_mhd.fluid_reconstruction = none.
...
Usage: analysis_mhd_reconstruction_identity.py <final>
       (the default-line twin is read from
        ../test_1d_theta_implicit_mhd_reconstruction_identity_default)
"""
...
TWIN = "../test_1d_theta_implicit_mhd_reconstruction_identity_default/diags/diag000050"
FIELDS = (
...
for name in FIELDS:
    ...
    if not identical:
        ...
        raise AssertionError(
            ...
            f"explicit fluid_reconstruction = none arm "
