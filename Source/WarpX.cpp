...
WarpX::ReadParameters ()
{
...

    {
        ...
        if(is_any_boundary_open){
            ...
            // face selects the Green's-function free-space boundary for the
            // B-field advance (see BoundaryConditions/GreensFunctionOpenBC).
            ...
            WARPX_ALWAYS_ASSERT_WITH_MESSAGE(
                ...
                "r_hi face where they select the Green's-function free-space boundary");
        }
...

    {
        ...
        if (evolve_scheme == EvolveScheme::Theta_Implicit_Hybrid) {
            ...
            if (solve_electron_energy_equation) {
                ...
                // Fast-ion stopping is coupled after the accepted implicit
                // step: a native endpoint background is frozen across the
                // collision batch and staged heat is consumed immediately.
